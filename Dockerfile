...
LABEL maintainer="Michael Chen <opensource@cnml.de>" \
      product="Autodiscover Email Settings" \
      version=$VERSION \
      org.label-schema.vcs-ref=$VCS_REF \
      org.label-schema.vcs-url="https://github.com/cn-ml/autodiscover-email-settings" \
      ...
      org.label-schema.url="https://github.com/cn-ml/autodiscover-email-settings" \
      org.label-schema.vendor="cn-ml" \
      org.label-schema.version=$VERSION \
      org.label-schema.schema-version="1.0" \
      org.opencontainers.image.revision=$VCS_REF \
      org.opencontainers.image.source="https://github.com/cn-ml/autodiscover-email-settings" \
      ...
      org.opencontainers.image.url="https://github.com/cn-ml/autodiscover-email-settings" \
      org.opencontainers.image.vendor="cn-ml" \
      org.opencontainers.image.version=$VERSION \
      org.opencontainers.image.authors="Michael Chen <opensource@cnml.de>"
